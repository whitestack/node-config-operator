...
func main() {
	...
	// Sets the list of secure cipher suites, to exclude the insecure
	// TLS_RSA_WITH_3DES_EDE_CBC_SHA.
	// This should be safe to remove in go1.23+.
	secureCiphers := func(c *tls.Config) {
	...
	tlsOpts = append(tlsOpts, secureCiphers)
